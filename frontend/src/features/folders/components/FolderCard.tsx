...
export const FolderCard: FC<FolderCardProps> = ({
    ...
    const base =
        'bg-[#161B22] border border-[#30363D] rounded-lg text-[#C9D1D9] overflow-hidden transition-all duration-200 hover:border-[#58A6FF] hover:shadow-[0_10px_30px_rgba(88,166,255,0.06)] cursor-pointer group';
